...
/* package tzfe-0.1.0.0 */
#ifndef VERSION_tzfe
#define VERSION_tzfe "0.1.0.0"
#endif /* VERSION_tzfe */
#ifndef MIN_VERSION_tzfe
#define MIN_VERSION_tzfe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tzfe */
...
#define CURRENT_COMPONENT_ID "tzfe-0.1.0.0-inplace-tzfe"
